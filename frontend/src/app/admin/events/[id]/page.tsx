...
export default function EditEventPage() {
    ...
    const [formData, setFormData] = useState({
        ...
        venue: "",
        category: "",
        type: "Other Events" as 'Sahara Fest' | 'Other Events',
        image_url: "",
        is_featured: false
    });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(err.message || err.details || "Failed to update event.");
        } finally {
            setSaving(false);
        }
    };
    ...
    return (
        <div className="p-8 max-w-3xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold font-serif text-black">Edit Event</h1>
                    <p className="text-gray-500 mt-1">Update the details for "{formData.title}".</p>
                </div>
            </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    value={formData.type}
                                    onValueChange={(val: 'Sahara Fest' | 'Other Events') => setFormData({ ...formData, type: val })}
                                >
